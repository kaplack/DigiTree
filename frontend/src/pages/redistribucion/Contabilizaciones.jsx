...
const ReContabilizaciones = () => {
  return (
    <>
      {/* Path Component */}
      <Path titulo="Redistribución" pagina="Contabilizaciones" />

      <div className="med-container">
        <h2 className="form-title">Contabilizaciones</h2>
        <form className="form">
...
export default ReContabilizaciones;
