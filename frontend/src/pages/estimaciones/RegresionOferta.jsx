...
const RegresionOferta = () => {
  return (
    <>
      {/* Path Component */}
      <Path titulo="Estimaciones" pagina="Regresión de la Oferta" />

      <div className="med-container">
        <h2 className="form-title">Regresión de la Oferta</h2>
        <form className="form">
...
export default RegresionOferta;
